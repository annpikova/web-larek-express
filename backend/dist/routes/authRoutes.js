...
router.post('/auth/register', registerValidation, authController_1.register);
router.post('/auth/login', loginValidation, authController_1.login);
router.get('/auth/token', authController_1.refreshAccessToken);
